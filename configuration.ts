// ShimmerEVM block time is 5s
export const SHIMMER_EVM_BLOCK_TIME = 5; // 5s
...
export const PROPOSAL_VOTING_PERIOD = (3 * 60 * 60) / SHIMMER_EVM_BLOCK_TIME; // 3 hours
...
export const PROPOSAL_LATE_QUORUM_EXTENSION =
  (3 * 60 * 60) / SHIMMER_EVM_BLOCK_TIME; // 3 hours
